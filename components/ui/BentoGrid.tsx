...
export const BentoGridItem = ({
  ...
  const rightLists = ["Remix", "TailwindCSS", "Prisma", "MongoDB"];

  const handleCopy = () => {
    navigator.clipboard.writeText("ammarm.odeh@gmail.com");
    setCopied(true);
    // Reset after 4 seconds so confetti can replay next time
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgb(0,1,4) 0%, rgba(12,14,35,1) 100%)",
      }}
    >
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              {/* Confetti Animation - Only renders on client */}
              <div
                className={`absolute -bottom-5 right-0 transition-opacity duration-500 ${
